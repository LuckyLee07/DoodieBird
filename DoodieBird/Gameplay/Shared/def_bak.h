...
#define SHIT_BULLET_DRAGON  14  //闪电便便
...
//豆子的分数
#define BEAN_SCORE   50

////关卡便便的类型数据
//static const int WeaponLevel[3][2] = {{3, 2}, {6, 3}, {9, 4}};

//障碍物介绍
static const int ObstacleLevel[7][2] = {{1, 2}, {2, 3}, {3, 4}, {5, 5}, {6, 6}, {8, 7}, {14, 8}};

//便便消耗豆子的分数
static const int UseBean[5] = {1, 5,  10, 15, 50};
...
//人物的积分
static const int HunterScore[4] = {150, 600, 1000, 3000};
